...
import com.example.explorecali.domain.TourRatingPk;
import com.example.explorecali.repo.TourRatingRepository;
...
public class TourRatingController {
    ...
    public Map<String, Double> getAverage(@PathVariable(value = "tourId") int tourId) {
        ...
        myMap.put("average", tourRatingRepository.findByPkTourId(tourId).stream()
    ...
    private TourRating verifyTourRating(int tourId, int customerId) throws NoSuchElementException {
        return tourRatingRepository.findByPkTourIdAndPkCustomerId(tourId, customerId).orElseThrow(() ->
                new NoSuchElementException("Tour Rating pait for request(" + tourId + " for customer " + customerId)
        );
    }
